...
import '../network/models/address/district.dart';
...
class AddressWrapper extends StatelessWidget {
  ...
  const AddressWrapper({super.key, required this.cubit});
      ...
      builder: (context, state) {
        return state.when(
          ...
          success: (data) {
            ...
            // final regionsData = data.first.regions!;
            // final regions = regionsData
            //     .map((e) => AddressInfo(id: e.id!, name: e.nameUz!))
            //     .toList();
            //
            // selectedRegionId.value = regionsData.first.id!;
            // final citiesData = data.first.regions!.first.cities!;
            // selectedCityId.value =
            //     citiesData.isEmpty ? -1 : citiesData.first.id!;
            // final cities = citiesData.isEmpty
            //     ? <AddressInfo>[]
            //     : citiesData
            //         .map((e) => AddressInfo(id: e.id!, name: e.nameUz!))
            //         .toList();
            //
            // final districtsData = citiesData.isEmpty ? <District>[] : citiesData.firstWhere((e) => e.id == selectedCityId.value).districts!;
            // final districts = citiesData.isEmpty
            //     ? <AddressInfo>[]
            //     : districtsData
            //         .map((e) => AddressInfo(id: e.id!, name: e.nameUz!))
            //         .toList();
            // selectedDistrictId.value =
            //     districtsData.isEmpty ? 0 : districtsData.first.id!;
            ...
            return Scaffold(
              ...
              body: SafeArea(
                child: Padding(
                  ...
                  child:
                      KeyboardVisibilityBuilder(builder: (context, isOpened) {
                        ...
                        children: [
                          ...
                          ValueListenableBuilder(
                            ...
                            builder: (context, id, _) {
                              ...
                              /// TODO: Take id, name into account if they are null or empty...
                              final regionsForUI = regionsData
                                  .map((e) =>
                                      AddressInfo(id: e.id!, name: e.nameUz!))
                                  .toList();

                              selectedRegionId.value = regionsForUI.first.id;
                              return Column(
                                children: [
                                  const Row(
                                    children: [
                          ...
                          ValueListenableBuilder(
                              ...
                              builder: (context, countryID, _) {
                                return ValueListenableBuilder(
                                  ...
                                  builder: (context, id, _) {
                                    if(countryID.isNegative || id.isNegative) {
                                    ...
                                    final citiesForUI = citiesData
                                        ...
                                        .toList();
                                    selectedCityId.value = citiesForUI.first.id;
                                    context.read<SignUpCubit>().setDistrictId(selectedRegionId.value);
                                    return Column(
                                      children: [
                                        SizedBox(height: 15.h),
                                        const Row(
                                ...
                                return ValueListenableBuilder(
                                    ...
                                    builder: (context, regionId, _) {
                                      return ValueListenableBuilder(
                                        ...
                                        builder: (context, id, _) {
                                          if(countryID.isNegative || regionId.isNegative || id.isNegative) {
                                          ...
                                          final city = region!.cities!
                                              .firstWhere((element) =>
                                                  element.id == id);
                                          final districtData = city.districts;
                                          ...
                                          context.read<SignUpCubit>().setDistrictId(selectedDistrictId.value);
                                          return Column(
                                            children: [
                                              SizedBox(height: 15.h),
                                              const Row(
