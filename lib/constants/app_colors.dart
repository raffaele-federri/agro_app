...
class AppColors {
  static const Color mainTextColor = Color(0xff226CB5);
  ...
  static const Color activeColor = Color(0xff00416A);
  static const Color textGrey = Color(0xff818E9B);
  static const Color mainScreenBackgroundColor = Color(0xffF8F9FA);
}
