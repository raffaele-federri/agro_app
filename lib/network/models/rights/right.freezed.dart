...
mixin _$Right {
  ...
  @JsonKey(ignore: true)
  $RightCopyWith<Right> get copyWith => throw _privateConstructorUsedError;
}
...
/// @nodoc
abstract class _$$_RightCopyWith<$Res> implements $RightCopyWith<$Res> {
...
class _$_Right implements _Right {
  const _$_Right(
      ...
      @JsonKey(name: 'short_description_ru') required this.shortDescriptionRu,
      @JsonKey(name: 'short_description_uz') required this.shortDescriptionUz,
      @JsonKey(name: 'short_description_en') required this.shortDescriptionEn,
  ...
  @override
  String toString() {
    return 'Right(id: $id, titleRu: $titleRu, titleUz: $titleUz, titleEn: $titleEn, shortDescriptionRu: $shortDescriptionRu, shortDescriptionUz: $shortDescriptionUz, shortDescriptionEn: $shortDescriptionEn, categories: $categories)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.shortDescriptionRu, shortDescriptionRu) ||
                other.shortDescriptionRu == shortDescriptionRu) &&
            (identical(other.shortDescriptionUz, shortDescriptionUz) ||
                other.shortDescriptionUz == shortDescriptionUz) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_RightCopyWith<_$_Right> get copyWith =>
      __$$_RightCopyWithImpl<_$_Right>(this, _$identity);
